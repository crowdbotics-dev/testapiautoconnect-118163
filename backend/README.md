...
## Project Structure
    ...
    ├── testapiautoconnect_118163  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_118163`
...
2. Clone this repo and `cd testapiautoconnect_118163`
